...
all=list(read(train_file))

train = []
test = []
for a, k in enumerate(all):
   if a%10 == 1:
      test.append(k)
   else:
      train.append(k) 
...
#print words, nwords, len(set(words))
#print train
...
RNN = dy.LSTMBuilder(1, 128, 256, model)

# Softmax weights/biases on top of LSTM outputs
W_sm = model.add_parameters((nwords, 256))
